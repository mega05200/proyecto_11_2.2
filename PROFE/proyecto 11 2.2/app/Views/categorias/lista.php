<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
          ...
          <div>
            <p>
                <a href="<?= site_url('categorias/registrar') ?>" class="btn btn-info">Registrar</a>
                <a href="<?= site_url('categorias/eliminadas') ?>" class="btn btn-secondary">Ver eliminadas</a>
            </p>
          </div>           
            <div class="card mb-4">
                            ...
                            <table id="datatablesSimple"class="table table-bordered" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= site_url('categorias/editar/') ?><?php echo $categoria['id']; ?>"
                                            class="btn btn-warning"><i class="fas fa-pencil-alt"></i></a>
                                            <a href="#" data-href="<?= site_url('categorias/eliminar/') ?><?php echo $categoria['id']; ?>"
